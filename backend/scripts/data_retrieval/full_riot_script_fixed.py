# The default script given that downloads game data from all tournaments
# in the data from the Riot S3 buckets. ~7 hours, ~700gb
...
def download_gzip_and_write_to_json(file_name):
   ...
   local_file_name = file_name.replace(':', '_')  # Replacing colon with underscore
